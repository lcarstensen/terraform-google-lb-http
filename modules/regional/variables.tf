...
variable "load_balancing_scheme" {
  description = "Scheme for load balancer backend and forwarding rule, can be EXTERNAL_MANAGED, or INTERNAL_SELF_MANAGED.  Defaults to EXTERNAL_MANAGED."
  type        = string
  default     = "EXTERNAL_MANAGED"
}

variable "region" {
  description = "Region to create internal or external load balancer."
  type = string
}
